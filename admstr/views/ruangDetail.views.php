...
?>
                                   ...
                                   while($data = mysqli_fetch_array($sql)) {
                                    ...
                                    echo " <a class='fa fa-edit' 
                                                 title='Edit data Barang' href='?page=forms&forms=barangForms&kdubah=$data[kd_barang]'
                                                    > Edit</a
                                                >
                                                ...
                                                >
                                                <a class='fa fa-book'  
                                                 title='Detail Data Barang' href='?page=views&views=barangDetailViews&kddetail=$data[kd_barang]'>
