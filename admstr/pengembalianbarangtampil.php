...
$sql = mysqli_query($koneksi, "SELECT barang.*, barang_kembali.*,barang_pinjam.*
FROM barang_kembali,barang,barang_pinjam
WHERE barang_kembali.kd_barang=barang.kd_barang 
AND barang_kembali.kd_pinjam=barang_pinjam.kd_pinjam");
 ?>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header" align="center">
                                <strong class="card-title"> Rekap Data Pengembalian Barang&nbsp;&nbsp;&nbsp; </strong>
                            </div>
