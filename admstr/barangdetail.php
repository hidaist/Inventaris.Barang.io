...
<div class="col-md-6" align="center">
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <strong class="card-title mb-3"><a  class="btn btn-success fa fa-book " title="Edit Data Barang" href="?page=editbarang&kdubah=<?php echo $data['kd_barang']; ?>"> Edit Data Barang</a>    
                                <a  class="btn btn-danger fa fa-trash " title="Hapus Data Barang" href="?page=hapusbarang&kdhapus=<?php echo $data['kd_barang']; ?>" onclick="return confirm('Beneran Mau di Hapus.?')"> Delete Data Barang</a></strong>
                            </div>
                            <div class="card-footer">
